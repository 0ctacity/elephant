...
func registerSearch(s *sdk.Server, service *app.Service, cwd func(string) string) {
	register(s, "search_entries", "Deterministic text search with composable filters and match metadata; project-scoped with stable ordering. updated_after/updated_before take RFC3339 timestamps; commit_start/commit_end match the inclusive bounds of an entry's commit range.", func(ctx context.Context, in searchInput) ([]app.SearchResult, error) {
